...
2026-09-14 独立公开源复验结果为 **658 项后端测试通过、7 项可选历史库回放跳过，41 项前端测试通过，构建成功**；原开发目录包含历史数据时合计 665 项后端测试通过。测试使用合成材料和模型/搜索桩，验证程序行为；本机 HTTP、SQLite 与历史浏览器验收的范围见 [评测与证据](docs/evaluation.md)。
